    ...
    <body class="skin-blue">
        <div class="wrapper">
            ...
            <header class="main-header">
                <!-- Logo -->
                <a href="index2.html" class="logo"><b>ADMIN</b>Next</a>
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <img src="<?php echo base_url('assets/img/avatar5'); ?>" class="img-circle" alt="user image"/>
                                                    </div>
                                                    <h4>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="beranda"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="datatelur"><i class="fa fa-circle-o"></i> Simple tables</a></li>
